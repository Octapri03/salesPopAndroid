...
public class Calzado extends Producto {
    ...
    public Calzado(int id_prod, String name, int price, String description, String ubication, NombreCategoria categoria, Date fechaPubli, Usuario vendedor, int talla) {
