...
public class Pc extends Producto {
    ...
    public Pc(int id_prod, String name, int price, String description, String ubication, NombreCategoria categoria, Date fechaPubli, Usuario vendedor, TipoPc tipo) {
